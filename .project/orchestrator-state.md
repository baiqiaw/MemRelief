...
step_status:
  ...
  "⑤.s1 测试": in_progress            # T-22（#24）采证进行中：29 行 GWT 全链 PASS 16/29，13 行引擎证据就位待真机手工（M1-M11）；§3.4 端到端 2142ms/整批释放 3031ms 达标；工作集超标（峰值 398.6MB vs 100MB，归因 .NET 10 运行时基线，#45）待 TL 裁决（docs/T-22-GWT验收矩阵.md）
