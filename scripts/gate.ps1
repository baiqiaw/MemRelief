# MemRelief 质量门禁入口：编译 → Core 引用门禁（法-1）→ 测试+覆盖率阈值（Core/App 两测试项目，≥80%，total line 口径）
...
Write-Host '=== 门禁 1/4：编译解决方案 ===' -ForegroundColor Cyan
...
Write-Host '=== 门禁 2/4：Core 引用检查（法-1） ===' -ForegroundColor Cyan
...
Write-Host '=== 门禁 3/4：Core 测试 + 覆盖率 ≥80% ===' -ForegroundColor Cyan
...
Write-Host '=== 门禁 4/4：App 测试 + 覆盖率 ≥80% ===' -ForegroundColor Cyan
